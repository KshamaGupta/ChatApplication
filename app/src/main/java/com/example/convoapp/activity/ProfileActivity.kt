...
import com.example.convoapp.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button4.setOnClickListener{
            if(binding.username4.text!!.isEmpty()){
    ...
    private fun uploadInfo(imgUrl:String){
        val user=UserModel(auth.uid.toString(),binding.username4.text.toString(),auth.currentUser!!.phoneNumber.toString(),imgUrl)
